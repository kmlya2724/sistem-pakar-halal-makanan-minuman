    ...
    <div class="flex p-8">
        ...
        <div class="w-3/4" style="margin-right: 20px; margin-left: 24px;">
            ...
            <div class="bg-white p-8 shadow-md" style="border-radius: 4px; margin-top: -10px; width: 820px; height: 352px;">
                <h2 class="text-center" style="font-size: 26px; margin-top: 64px;">Selamat Datang di HalalTrust!</h2>
                <p class="text-center" style="margin-top: 20px;">
                    Kami hadir untuk memudahkan Anda mengecek kehalalan produk <br>
                    dan layanan dengan cepat dan terpercaya. Temukan informasi <br>
                    yang Anda butuhkan agar setiap pilihan Anda semakin yakin dan <br>
