...
$query = "SELECT username, agama, negara, jenis_kelamin FROM `user` WHERE email = ?";
...
<body>
    ...
    <div class="flex p-8">
        ...
        <div class="w-3/4" style="margin-right: 20px; margin-left: 24px;">
            ...
            <div class="bg-white p-8 shadow-md" style="border-radius: 4px; margin-top: -10px; width: 820px; height: 458px;">
                <form method="POST" action="update_user.php">
                    <div class="mb-4">
                        <label style="color: #999999;">
                            Nama Pengguna
                        </label>
                        <input name="username" class="w-full border-b-4 border-[#999999] outline-none py-2" type="text" value="<?php echo htmlspecialchars($userData['username']); ?>"/>
                    </div>
                    <div class="mb-4">
                        <label style="color: #999999;">
                            Agama
                        </label>
                        <input name="agama" class="w-full border-b-4 border-[#999999] outline-none py-2" type="text" value="<?php echo htmlspecialchars($userData['agama']); ?>"/>
                    </div>
                    <div class="mb-4">
                        <label style="color: #999999;">
                            Negara
                        </label>
                        <input name="negara" class="w-full border-b-4 border-[#999999] outline-none py-2" type="text" value="<?php echo htmlspecialchars($userData['negara']); ?>"/>
                    </div>
                    <div class="mb-4">
                        <label style="color: #999999;">
                            Jenis Kelamin
                        ...
                        <div class="flex items-center mt-4">
                            <input class="mr-2" id="laki-laki" name="jenis_kelamin" type="radio" value="Laki-laki" <?php echo $userData['jenis_kelamin'] === 'Laki-laki' ? 'checked' : ''; ?>/>
                            <label class="mr-12" for="laki-laki">Laki-laki</label>
                            <input class="mr-2" id="perempuan" name="jenis_kelamin" type="radio" value="Perempuan" <?php echo $userData['jenis_kelamin'] === 'Perempuan' ? 'checked' : ''; ?>/>
                            <label class="mr-12" for="perempuan">Perempuan</label>
                            <input class="mr-2" id="none" name="jenis_kelamin" type="radio" value="" <?php echo $userData['jenis_kelamin'] === '' ? 'checked' : ''; ?>/>
                            <label for="none">Memilih untuk tidak menyebutkan</label>
                        </div>
                    </div>
                    <div class="flex justify-center mt-10">
                        <button type="submit" class="text-white p-2 px-6 btn-hover" style="background-color: #0F52BA; border-radius: 4px;">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
